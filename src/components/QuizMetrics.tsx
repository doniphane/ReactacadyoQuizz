// Composant pour afficher les métriques des résultats de quiz
// Ce composant affiche les statistiques clés des résultats

import { Card, CardContent } from '@/components/ui/card';
import { Users, TrendingUp, Trophy, TrendingDown, Target } from 'lucide-react';

// Import des types
import type { Metrics } from '../types/quizresultdetail';
