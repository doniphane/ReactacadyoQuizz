...
import type { TransformedAttempt } from '../types/studenthistory';
...
/**
 * Composant pour afficher la liste des tentatives de quiz
 * Affiche chaque tentative avec ses informations de base
 */
