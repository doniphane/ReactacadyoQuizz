// Service utilitaire pour l'export PDF des résultats de quiz
// Ce service gère la génération de PDF pour les résultats individuels et globaux

import jsPDF from 'jspdf';
import toast from 'react-hot-toast';

// Import des types
import type { Student, AnswerDetail } from '../types/quizresultdetail';
...
/**
 * Export PDF pour tous les résultats d'un quiz
 * @param data - Données des étudiants et du quiz
 */
...
/**
 * Export PDF pour un étudiant spécifique
 * @param data - Données de l'étudiant et de ses réponses
 */
