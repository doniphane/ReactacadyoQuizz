// Composant pour afficher les résultats détaillés d'un étudiant
// Ce composant affiche le score et les détails des réponses d'un étudiant
...
interface StudentResultsDetailProps {
